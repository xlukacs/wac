 ...
 const sampleConditions: Condition[] = [
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<lbm-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [LbmAmbulanceWlEditor],
       html: `<lbm-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></lbm-ambulance-wl-editor>`,
    });
